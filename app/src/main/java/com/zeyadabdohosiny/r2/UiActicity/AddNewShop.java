...
public class AddNewShop extends AppCompatActivity {
    ...
    public void AddnewShop(View view) {
        ...
        // Paswword to Go to next Activity
        ...
        if (Password.getText().toString().equalsIgnoreCase("terrors123456") == true) {
            ...
            ShopRef.document(UserKey).set(new Shop(UserKey, nameofTheShop, userImageUri, lang, latd, 0));
    ...
    // Method Upload the Image to FireStorage
